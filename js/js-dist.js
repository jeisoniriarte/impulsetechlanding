if (function(e, t) {
	...
	T.fn = T.prototype = {
		...
		var e, t, n, r, i, o, a = arguments[0] || {},
			...
			l = arguments.length,
			u = !1;
		for ("boolean" == typeof a && (u = a, a = arguments[s] || {}, s++), "object" == typeof a || T.isFunction(a) || (a = {}), s === l && (a = this, s--); s < l; s++) if (null != (e = arguments[s])) for (t in e) n = a[t], a !== (r = e[t]) && (u && r && (T.isPlainObject(r) || (i = T.isArray(r))) ? (i ? (i = !1, o = n && T.isArray(n) ? n : []) : o = n && T.isPlainObject(n) ? n : {}, a[t] = T.extend(u, o, r)) : void 0 !== r && (a[t] = r));
		return a
	}, T.extend({
	...
	var p = function(n) {
		...
		for (e in h = re.support = {}, i = re.isXML = function(e) {
					...
					function(e) {
						...
						if (c) {
							...
							if (l = [y ? c.firstChild : c.lastChild], y && f) {
								for (p = (s = (r = (i = (o = (a = c)[T] || (a[T] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0] === A && r[1]) && r[2], a = s && c.childNodes[s]; a = ++s && a && a[u] || (p = s = 0) || l.pop();) if (1 === a.nodeType && ++p && a === e) {
									i[h] = [A, s, p];
									break
								}
							} else if (f && (p = s = (r = (i = (o = (a = e)[T] || (a[T] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0] === A && r[1]), !1 === p) for (;
			...
			pseudos: {
				...
				lang: oe(function(n) {
					return B.test(n || "") || re.error("unsupported lang: " + n), n = n.replace(ee, te).toLowerCase(), function(e) {
						var t;
						do {
		...
		function be(e) {
			for (var i, t, n, r = e.length, o = x.relative[e[0].type], a = o || x.relative[" "], s = o ? 1 : 0, l = ge(function(e) {
				...
				return i = null, r
			}]; s < r; s++) if (t = x.relative[e[s].type]) c = [ge(me(c), t)];
			else {
	...
	(T.fn.init = function(e, t, n) {
		...
		if (n = n || A, "string" == typeof e) {
			...
			if (r[1]) {
				if (t = t instanceof T ? t[0] : t, T.merge(this, T.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : E, !0)), x.test(r[1]) && T.isPlainObject(t)) for (r in t) T.isFunction(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
				return this
			}
	...
	var D = function(e, t, n, r, i, o, a) {
		var s = 0,
			l = e.length,
			u = null == n;
		if ("object" === T.type(n)) for (s in i = !0, n) D(e, t, s, n[s], !0, o, a);
	...
	function R(e, t, n) {
		var r;
		if (void 0 === n && 1 === e.nodeType) if (r = "data-" + t.replace($, "-$&").toLowerCase(), "string" == typeof(n = e.getAttribute(r))) {
			try {
	...
	function ne(e, t, n, r, i) {
		for (var o, a, s, l, u, c, d = t.createDocumentFragment(), f = [], p = 0, h = e.length; p < h; p++) if ((o = e[p]) || 0 === o) if ("object" === T.type(o)) T.merge(f, o.nodeType ? [o] : o);
		else if (te.test(o)) {
		...
		for (d.textContent = "", p = 0; o = f[p++];) if (r && -1 < T.inArray(o, r)) i && i.push(o);
		else if (u = T.contains(o.ownerDocument, o), a = Q(d.appendChild(o), "script"), u && Z(a), n) for (c = 0; o = a[c++];) G.test(o.type || "") && n.push(o);
		return d
	}
	...
	T.event = {
		...
		add: function(t, e, n, r, i) {
			...
			if (m) for (n.handler && (n = (o = n).handler, i = o.selector), n.guid || (n.guid = T.guid++), (l = m.events) || (l = m.events = {}), (a = m.handle) || (a = m.handle = function(e) {
		...
		remove: function(e, t, n, r, i) {
			...
			if (m && (l = m.events)) {
				for (u = (t = (t || "").match(j) || [""]).length; u--;) if (p = g = (s = oe.exec(t[u]) || [])[1], h = (s[2] || "").split(".").sort(), p) {
	...
	function ye(e, t) {
		var n, r, i, o, a, s, l, u;
		if (1 === t.nodeType) {
			if (H.hasData(e) && (o = H.access(e), a = H.set(t, o), u = o.events)) for (i in delete a.handle, a.events = {}, u) for (n = 0, r = u[i].length; n < r; n++) T.event.add(t, i, u[i][n]);
	...
	function be(n, r, i, o) {
		...
		if (d && (t = (e = ne(r, n[0].ownerDocument, !1, n, o)).firstChild, 1 === e.childNodes.length && (e = t), t || o)) {
			...
			if (s) for (u = a[a.length - 1].ownerDocument, T.map(a, ve), c = 0; c < s; c++) l = a[c], G.test(l.type || "") && !H.access(l, "globalEval") && T.contains(u, l) && (l.src ? T._evalUrl && T._evalUrl(l.src) : T.globalEval(l.textContent.replace(he, "")))
		}
		return n
	}
	function xe(e, t, n) {
	...
	T.extend({
		...
		clone: function(e, t, n) {
			...
			if (!(m.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || T.isXMLDoc(e))) for (a = Q(c), r = 0, i = (o = Q(e)).length; r < i; r++) s = o[r], l = a[r], void 0, "input" === (u = l.nodeName.toLowerCase()) && X.test(s.type) ? l.checked = s.checked : "input" !== u && "textarea" !== u || (l.defaultValue = s.defaultValue);
			if (t) if (n) for (o = o || Q(e), a = a || Q(c), r = 0, i = o.length; r < i; r++) ye(o[r], a[r]);
			else ye(e, c);
	...
	function Je(o, e, t) {
		...
		for (function(e, t) {
			var n, r, i, o, a;
			for (n in e) if (i = t[r = T.camelCase(n)], o = e[n], T.isArray(o) && (i = o[1], o = e[n] = o[0]), n !== r && (e[r] = o, delete e[n]), (a = T.cssHooks[r]) && "expand" in a) for (n in o = a.expand(o), delete e[r], o) n in e || (e[n] = o[n], t[n] = i);
			else t[r] = i
		}(c, u.opts.specialEasing); r < i; r++) if (n = Je.prefilters[r].call(u, o, c, u.opts)) return T.isFunction(n.stop) && (T._queueHooks(u.elem, u.opts.queue).stop = T.proxy(n.stop, n)), n;
	...
	T.fn.extend({
		...
		removeAttr: function(e, t) {
			var n, r, i = 0,
				o = t && t.match(j);
			if (o && 1 === e.nodeType) for (; n = o[i++];) r = T.propFix[n] || n, T.expr.match.bool.test(n) && (e[r] = !1), e.removeAttribute(n)
		}
	}), et = {
		set: function(e, t, n) {
	...
	T.fn.extend({
		addClass: function(t) {
			...
			if ("string" == typeof t && t) for (e = t.match(j) || []; n = this[l++];) if (i = ot(n), r = 1 === n.nodeType && (" " + i + " ").replace(it, " ")) {
		...
		toggleClass: function(i, t) {
			...
			return "boolean" == typeof t && "string" === o ? t ? this.addClass(i) : this.removeClass(i) : T.isFunction(i) ? this.each(function(e) {
				...
				var e, t, n, r;
				if ("string" === o) for (t = 0, n = T(this), r = i.match(j) || []; e = r[t++];) n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
	...
	function wt(o) {
		return function(e, t) {
			...
			if (T.isFunction(t)) for (; n = i[r++];)"+" === n[0] ? (n = n.slice(1) || "*", (o[n] = o[n] || []).unshift(t)) : (o[n] = o[n] || []).push(t)
		}
	}
	function St(t, i, o, a) {
		var s = {},
	...
	var i, l, u = {},
		...
		y = v.slice,
		b = {}.hasOwnProperty;
	for (var x in l = a(b, "undefined") || a(b.call, "undefined") ?
	function(e, t) {
	...
	return u.addTest = function(e, t) {
		if ("object" == typeof e) for (var n in e) l(e, n) && u.addTest(n, e[n]);
		else {
		...
		function() {
			try {
				...
				e.innerHTML = "<xyz></xyz>", f = "hidden" in e, p = 1 == e.childNodes.length ||
				function() {
					l.createElement("a");
	...
	function n(e, t, n, r, i) {
		return w = 0, t = t || "j", p(e) ?
		function(n, r, e, t, i, o, a) {
			function s(e) {
				if (!u && g(l.readyState) && (d.r = u = 1, !w && m(), l.onload = l.onreadystatechange = null, e)) for (var t in "img" != n && y(function() {
					C.removeChild(l)
	...
	(v = function(e) {
		...
		function t(e, t) {
			function n(n, e) {
				if (n) {
					...
					else if (Object(n) === n) for (i in r = function() {
						var e, t = 0;
		...
		if (p(e)) c(e, 0, i, 0);
		else if (E(e)) for (n = 0; n < e.length; n++) p(r = e[n]) ? c(r, 0, i, 0) : E(r) ? v(r) : Object(r) === r && t(r, i);
			...
			C = {
				chbreakpoint: function() {
					if (o = E(window).width(), c.responsive.length) {
						var e;
						if (!1 === c.autoWidth && (e = c.item), o < c.responsive[0].breakpoint) for (var t = 0; t < c.responsive.length; t++) o < c.responsive[t].breakpoint && (c.responsive[t].breakpoint, a = c.responsive[t]);
						if (null != a) for (var n in a.settings) a.settings.hasOwnProperty(n) && ((void 0 === i[n] || null === i[n]) && (i[n] = c[n]), c[n] = a.settings[n]);
		...
		return (n = {
			...
			initialStyle: function() {
				...
				"fade" === c.mode && (c.autoWidth = !1, c.slideEndAnimation = !1), c.auto && (c.slideEndAnimation = !1), c.autoWidth && (c.slideMove = 1, c.item = 1), c.loop && (c.slideMove = 1, c.freeMove = !1), c.onBeforeStart.call(this, d), C.chbreakpoint(), d.addClass("lightSlider").wrap('<div class="lSSlideOuter ' + c.addClass + '"><div class="lSSlideWrapper"></div></div>'), h = d.parent(".lSSlideWrapper"), !0 === c.rtl && h.parent().addClass("lSrtl"), c.vertical ? (h.parent().addClass("vertical"), p = c.verticalHeight, h.css("height", p + "px")) : p = d.outerWidth(), u.addClass("lslide"), !0 === c.loop && "slide" === c.mode && (C.calSW(), C.clone = function() {
					if (C.calWidth(!0) > p) {
						...
						if (r < d.find(".clone.right").length) for (var o = u.length - 1; o > u.length - 1 - d.find(".clone.right").length; o--) g--, u.eq(o).remove();
			...
			touchMove: function(e, t) {
				if (h.css("transition-duration", "0ms"), "slide" === c.mode) {
					var n = y - (e - t);
					if (n >= f - p - c.slideMargin) if (!1 === c.freeMove) n = f - p - c.slideMargin;
					else {
			...
			touchEnd: function(e) {
				if (h.css("transition-duration", c.speed + "ms"), "slide" === c.mode) {
					...
					var n = function(e) {
						var t = 0;
						if (o || e && (t = 1), c.autoWidth) for (var n = 0, r = 0; r < u.length && (n += parseInt(u.eq(r).width()) + c.slideMargin, g = r + t, !(y <= n)); r++);
						else {
...
function(e, t) {
	...
	function A(e) {
		...
		function f(t) {
			for (var e = 0, n = {}, r = x.animations, i = r.length; e < i;) {
				...
				if (s = l.length) for (f = l[0], u = 0; u < s; u++) c = l[u + 1], p = d[u], isNaN(p) || (f = c ? f + (p + c) : f + (p + " "));
				else f = d[0];
				D[o.type](a.target, o.property, f, n, a.id), o.currentValue = f, e++
			}
			if (e = Object.keys(n).length) for (r = 0; r < e; r++) k || (k = S(document.body, "transform") ? "transform" : "-webkit-transform"), x.animatables[r].target.style[k] = n[r].join(" ");
	...
	return A.version = "2.2.0", A.speed = 1, A.running = L, A.remove = function(e) {
		e = b(e);
		for (var t = L.length; t--;) for (var n = L[t], r = n.animations, i = r.length; i--;) a(e, r[i].animatable.target) && (r.splice(i, 1), r.length || n.pause())
	...
	return function e(t) {
		...
		"object" == typeof t && (t = function(e) {
			...
			for (void 0 === e.suffix && (e.suffix = e.postfix), t = 0; t < o.length; t += 1) if (void 0 === (r = e[n = o[t]]))"negative" !== n || i.negativeBefore ? "mark" === n && "." !== i.thousand ? i[n] = "." : i[n] = !1 : i[n] = "-";
			else if ("decimals" === n) {
	...
	function j(e, d, o) {
		var l, u, s, a, c, t, f, i, p = window.navigator.pointerEnabled ? {
			...
			h = window.CSS && CSS.supports && CSS.supports("touch-action", "none") &&
			function() {
				var e = !1;
				try {
			...
			var p, h, g, m, t, n, v, y, b, r = e.mode,
				...
				s = (p = i, h = r, g = a, m = {}, t = w.xVal[0], n = w.xVal[w.xVal.length - 1], y = v = !1, b = 0, (g = g.slice().sort(function(e, t) {
					...
					var n, r, i, o, a, s, l, u, c, d = e,
						f = g[t + 1];
					if ("steps" === h && (n = w.xNumSteps[t]), n || (n = f - d), !1 !== d && void 0 !== f) for (n = Math.max(n, 1e-7), r = d; r <= f; r = (r + n).toFixed(7) / 1) {
		...
		return ne(t = x, d.cssClasses.target), 0 === d.dir ? ne(t, d.cssClasses.ltr) : ne(t, d.cssClasses.rtl), 0 === d.ort ? ne(t, d.cssClasses.horizontal) : ne(t, d.cssClasses.vertical), l = A(t, d.cssClasses.base), function(e, t) {
